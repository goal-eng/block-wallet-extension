...
declare global {
    interface Window {
        ...
        SolflareApp?: unknown;
        trustedTypes?: {
            createPolicy: (policyName: string, policyOptions: { createHTML: (input: string, sink: any) => string }) => void;
        };
    }
}
